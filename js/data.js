...
const mysteryBoxes = [
    ...
    { name: "의문의 상자", x: -6523, y: 76, z: 2194, item: "일반부적뽑기", entrance: "x:-6518 y:89 z:2366" },
    ...
    { name: "의문의 상자", x: -5162, y: 130, z: -2982, item: "고급주문서뽑기", entrance: "x:-5177 y:137 z:-2995" },
...
const npcData = [
    ...
    { name: "몰락한소가주", x: 3139, y: 78, z: -2583, quest: "??? <br>[무인의거처] : 2층 침대 클릭시 힘+1</br>", file: "sogaju.png" },
    ...
    crafting: [
        ...
        { name: "목판", materials: "낡은목간2 + 강철1 + 송진덩어리2 + 돌덩어리2", img: "item4.png"}, 
        { name: "옥장식편", materials: "깨진옥장식2 + 자금1 + 청연광3 + 돌덩어리2", img: "item5.png"},  
        { name: "기와문양판", materials: "깨진기와2 + 강철1 + 적동괴1 + 송진덩어리1 + 돌덩어리2", img: "item6.png"}, 
        { name: "접합제", materials: "송진칠료1 + 강철2 + 돌덩어리3 + 갈옥1 + 향목가루1", img: "item7.png"}, 
        { name: "청동각인판", materials: "와편분말1 + 오금철1 + 청동파편2 + 매화옥1 + 청연광2 ", img: "item8.png"}, 
        { name: "강화목", materials: "목심재1 + 백련강1 + 신선옥2 + 마모된인장2 + 돌덩어리2", img: "item9.png"}, 
        { name: "기문부적", materials: "목판1 + 백련정강1 + 청강석2 + 잔존영석3", img: "item10.png"},
        { name: "정련실", materials: "기와문양판1 + 강오금1 + 현철2 + 연마사3", img: "item11.png"}, 
        { name: "옥문장식판", materials: "옥장식편1 + 백현철1 + 무괴철1 + 매화옥2 + 봉인된철편3", img: "item12.png"}, 
        { name: "한철단조석", materials: "접합제2 + 한철2 + 금강석1 + 연마사2 + 봉인된철편4", img: "item13.png"}, 
        { name: "설화정련석", materials: "청동각인판2 + 빙옥5 + 청강석2 + 흑옥4 + 잔존영석4", img: "item14.png"}, 
        { name: "금강각인편", materials: "강화목2 + 금강석3 + 깨진옥장식2 + 자금1 + 연마사4", img: "item15.png"}
    ]
},
...
// [무공비급 데이터]
//- 홍매지폭, 부화검결 + 홍련업화 + 철목영지 + 정적주10 + 무공정수50 + 3만전
//- 혈마검법
//- 부화검결, 송진덩어리2 + 신선옥15 + 매화옥15 + 옥장식편1 + 백련강1 +  무공정수20 + 3만전
//- 파력검법
//- 열화신공
//- 흑무검법
//- 청무검법
//- 수류검법
//- 초살선풍, 기와문양판1 + 무괴철1 + 갈옥15 + 무공정수30 + 3만전
//- 빙설검법
//- 혈사검법
//- 매화초검, 목심재 + 옥장식편 + 매화옥20 + 무공정수10 + 3만전
//- 섬멸검법, 단섬검법 + 강철1 + 자금1 + 무공정수20 + 3만전
//- 천살검법, 섬멸검법 + 혈사검법 + 월계엽1 + 한철단조석1 + 기문부적1 + 금강한철
//- 매화쾌검
//- 창천검법, 강오금1 + 백현철1 + 청동각인판1 + 청연광20 + 무공정수30 + 3만전
//- 연검법
//-월섬검법
//- 단섬검법
//- 천뢰공, 무림맹비급 + 벽력공 + 대장장이의불50 + 금향과1 + 철목영지1 + 무공정수60 + 10만전
//- 벽뢰공, 토끼내단10 + 1만전
