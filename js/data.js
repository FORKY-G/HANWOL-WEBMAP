...
const npcData = [
    { name: "도사", lv: 50, x: -1293, y: 290, z: -598, quest: "[히든]십이지신, [히든]호리병을 찾아서,<br>[히든]심마니", item: "[히든]심마니 : 백향초1개,무공정수20개", route: "[히든]호리병을 찾아서 : 도사 > 도공 > 멸문대(수상한포탈) > 도사", reward: "금환단, 부화검결", memo: "", file: "dosa.png" },
    ...
    { name: "척후병", lv: 102, x: -3963, y: 148, z: 2613, quest: "혈교 상자 찾기", item: "정적주", records: [ {n:'상자1', x: -3939, y: 13, z: 2045}, {n:'상자2', x: -4097, y: 13, z: 2168}, {n:'상자3(빙백설화필요)', x: -3880, y: -30, z: 2303}], reward: "혈마베기", file: "scout.png" },
...
const huntingGrounds = [
    ...
    { name: "멸문", lv: "40~50", monsters: "뱀(lv.40), 청사(lv.45), 적사(lv.50)", memo: "*구렁이 출현(파력검법)", file: "map4.png", x: 3858, y: 131, z: -2635 },
